...
class ApiService implements IApiService {
  ...
  private authenticate = (): Promise<string> => {
    return new Promise((resolve, reject) => {
      this.getAccessToken ? resolve(this.getAccessToken()) : resolve(localStorage.getItem('accessToken') || '');
    });
  };
...
export const { get, remove, removeJSON, post, postJSON, postFile, put, putJSON, setConfiguration } = sfApi;
